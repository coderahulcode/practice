...
public class AddQuestionSports extends JFrame implements ActionListener{
	...
	JTextArea tqname;
	 ...
	 int a=0;
	 ResultSet rs;
	public AddQuestionSports() {
		//setLayout(200,200);
		setSize(300,300);
		setVisible(true);
		setTitle("Sports Question Panel");
		p=new JPanel();
	...
	public void actionPerformed(ActionEvent ee)
	{
		...
		if (ee.getSource()==bt) {
			...
			String sql1="Select Max(Qid) from sportsq";
			...
			try {
				...
				System.out.println("Execute="+(a));
				 ...
				 sql="INSERT INTO sportsq (qid ,QueName ,qA,qB ,qC ,qd,qAns) VALUES('"+a+"','" +tqname.getText()+"','"
