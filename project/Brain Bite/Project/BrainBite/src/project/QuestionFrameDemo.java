...
public class QuestionFrameDemo extends JFrame implements ActionListener {
	...
	String sql="Select * from demoQ where qid="+1;
	ResultSet rs;
	try {
	...
	public static void main(String[] args) throws SQLException {
		...
		QuestionFrameDemo q=new QuestionFrameDemo();
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getActionCommand().equals("Next"))
		{
			try {
				...
				ResultSet rs;
				qid++;
				String sql="Select * from demoQ where qid="+qid;
				rs=DbcPassword.stmt.executeQuery(sql);
				if(rs.next()){
			   qid=rs.getInt("qid");
			   jlQNo.setText("Q"+rs.getString("qid"));
				...
				rd.setText(rs.getString("qd"));
					...
					JOptionPane.showMessageDialog(this, "Total Questions are: "+(--qid)+"     Correct questions are: 3"+"     Your score is: 4");
