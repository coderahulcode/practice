...
public class AddQuestionTechnical extends JFrame implements ActionListener{
	...
	JTextArea tqname;
	 ...
	 int a=0;
	 ResultSet rs;
	public AddQuestionTechnical() {
		//setLayout(200,200);
		setSize(300,300);
		setVisible(true);
		setTitle("Technical Question Panel");
		p=new JPanel();
	...
	public void actionPerformed(ActionEvent ee)
	{
		...
		if (ee.getSource()==bt) {
			...
			String sql1="Select Max(Qid) from technicalq";
			...
			try {
				...
				System.out.println("Execute="+(a));
				 ...
				 sql="INSERT INTO technicalq (qid ,QueName ,qA,qB ,qC ,qd,qAns) VALUES('"+a+"','" +tqname.getText()+"','"
