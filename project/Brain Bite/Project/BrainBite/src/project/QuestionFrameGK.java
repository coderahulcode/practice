...
public class QuestionFrameGK  extends JFrame implements ActionListener {
...
//	btfini=new JButton("Finish");
	...
	String sql="Select * from gkq where qid="+1;
	ResultSet rs;
	try {
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getActionCommand().equals("Next"))
		{
			try {
				...
				ResultSet rs;
				qid++;
				String sql="Select * from gkq where qid="+qid;
				rs=DbcPassword.stmt.executeQuery(sql);
				if(rs.next()){
			   qid=rs.getInt("qid");
			   jlQNo.setText("Q"+rs.getString("qid"));
				...
				rd.setText(rs.getString("qd"));
					...
					JOptionPane.showMessageDialog(this, "Total Questions are: "+(--qid)+"    Correct questions are: 4"+"     Your score is: 7");
