...
public class SimpleMailDemo 
{
    ...
    String port = "587";
    String mailFrom = "j4ubatch14@gmail.com";
    String password = "parwinder";
    ...
    public static void main(String[] args) 
    {
            ...
            SimpleMailDemo obj = new SimpleMailDemo("harpreetnarula002@gmail.com","Hello","testing mail...from sahil p_d");
    }
}
