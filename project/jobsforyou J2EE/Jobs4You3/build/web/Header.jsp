 <script>
    function goheader(e)
    {
       if(e.keyCode ===13)
       {
           ...
           window.location.href="CompanySearch.jsp?search="+name;
       }
    ...
    <table id="Table_01" width="980" height="136" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    <a href="Home.jsp"><img src="images/header_03.png" width="113" height="123" alt=""></a></td>
                <td rowspan="2">
            ...
            <div  style="position:absolute">
                <input type="text"  id="search" style=" margin-left: 690px;  margin-top:80px;" class="textbox" onkeyup="goheader(event)"/>
