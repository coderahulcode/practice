<%-- 
    Document   : UploadPhoto2Student
    Created on : May 14, 2014, 7:39:11 AM
    Author     : Harpreet
--%>
    ...
    <body>
        ...
        <%
                ...
                if(rs.next())
                {
                    ...
                    rs.updateRow();
                    response.sendRedirect("StudentHome.jsp?msg=Uploaded PIcture Seccessfuly !");
                }
            } 
            catch (Exception ex)
            {
