...
CREATE TABLE `shortlisted_students` (
  ...
  KEY `pid_fk` (`pid`),
  CONSTRAINT `pid_fk` FOREIGN KEY (`pid`) REFERENCES `placementdrive` (`pid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `student_fk` FOREIGN KEY (`studentid`) REFERENCES `student` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `shortlisted_students` VALUES (1,1,1),(2,2,1),(3,1,2),(4,2,2),(5,4,2),(6,1,3),(7,2,3),(8,1,4),(9,2,4),(10,4,4),(11,5,4),(12,2,5),(13,2,6),(14,5,6),(15,8,7),(16,2,8),(17,8,9),(18,5,10),(19,8,10),(20,1,12),(21,5,12);
...
-- Dump completed on 2016-02-07 17:29:38
