...
CREATE TABLE `marks_type` (
  ...
  `marks_type` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
LOCK TABLES `marks_type` WRITE;
/*!40000 ALTER TABLE `marks_type` DISABLE KEYS */;
INSERT INTO `marks_type` VALUES (1,'Percentage'),(2,'C.G.P.A'),(3,'Percentile');
...
-- Dump completed on 2016-02-07 17:30:50
