...
public class CustomerProfile extends JFrame implements ActionListener
{
   ...
   Point p;
    ...
    f2=new Font("Times New Roman",Font.PLAIN,14);
     ...
     l1=new JLabel("CUSTOMER PROFILE");
    l2=new JLabel("Name");
    ...
    b1.addActionListener(this);
     try
      ...
      String accno,name,fname,dob,gender,state,address,email,date,wname,waccno;
      long pno,wpno;
      while(rs.next())
      {
          ...
          wname=rs.getString("witnessname");
          waccno=rs.getString("witnessaccno");
          wpno=rs.getLong("witnesspno");
          al.add(new cprofile(accno,name,fname,dob,gender,state,address,email,pno,date,wname,waccno,wpno));
    ...
    public void actionPerformed(ActionEvent e) 
    {
     ...
     String accno=i.accno;
      String name,fname,dob,gender,state,address,email,wname,waccno;
      long pno,wpno;
     ...
     while(rs.next())
     {
         ...
         if(rs.getString("accno").equals(accno))
         {
          ...
          Cupdate cu=new Cupdate(accno,sn[0],sn[1],sn[2],fname,dob,gender,state,address,email,pno,wname,waccno,wpno);
         }
     }
         }
          catch(Exception ex)
   ...
   id1=i.accno;
    ...
    while(rs.next())
      {
          if(rs.getString("accno").equals(id1))
    ...
    {
        String title[] = {"ACCOUNT NUMBER","NAME","FATHER NAME","DATE OF BIRTH","GENDER","STATE","FULL ADDRESS","EMAIL-ID","PHONE NUMBER","DATE OF OPENING ACCOUNT","WITNESS-NAME","WITNESS-ACCOUNT NUMBER","WITNESS-PHONE NUMBER"};
        ...
        public Object getValueAt(int row, int col) 
        {
            if(col==0)
                ...
                return al.get(row).name;
                 ...
                 return al.get(row).wname;
                    else if(col==11)
                 return al.get(row).waccno;
                     else 
                 return al.get(row).wpno;
...
class cprofile
{
    ...
    cprofile(String accno, String name, String fname, String dob, String gender, String state, String address, String email, long pno, String date, String wname, String waccno, long wpno) 
    {
      this.accno=accno;
      this.name=name;
      this.fname=fname;
